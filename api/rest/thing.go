...
type thing struct {
	svc backbone.ThingService
}

// NewEndpoint will setup and return a new thing handler.
func NewEndpoint(svc backbone.ThingService) *thing {
